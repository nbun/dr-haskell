-- | Check to find shadowed identifiers
module StaticAnalysis.StaticChecks.Shadowing (shadowing) where

import           AstChecks.Check                      (DeclCheck, ExpCheck, cId,
                                                       mapOverRhsNew)
...
-- | Checks for shadowed identifiers
